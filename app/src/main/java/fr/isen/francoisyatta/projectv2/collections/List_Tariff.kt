...
import fr.isen.francoisyatta.projectv2.RequestCode
import fr.isen.francoisyatta.projectv2.TariffActivity
import fr.isen.francoisyatta.projectv2.Adapter.Adapter_Tariff
...
class List_Tariff : ListActivity()  {
    private val dialogHelper = DialogHelper()
    private var meterPosition = 0
    private var deletePosition = 0

    private lateinit var meter: Meter
    private lateinit var adapterTariff: Adapter_Tariff
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapterTariff = Adapter_Tariff(this, R.id.tariff_row, meter.tariffs)
    ...
    private fun create() {
        val intent = Intent(this@List_Tariff, TariffActivity::class.java)
